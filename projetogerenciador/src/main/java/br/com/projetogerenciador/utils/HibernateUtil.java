package br.com.projetogerenciador.utils;
...
import br.com.projetogerenciador.implementacaocrud.VariavelConexaoUtil;
 ...
 * @Autor Pedro
 */
@ApplicationScoped //Aqui aviso ao JSF que é o Hibernate de conexão única
public class HibernateUtil implements Serializable{
	...
	/*
	 * @return Conexão no Initial Context java:/comp/env/jdbc/datasource
	 * @throws Exception
	 */
